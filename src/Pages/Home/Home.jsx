...
const Home = () => {
	...
	useEffect(() => {
		...
		const handleWheel = (e) => {
			if (e.deltaY > 0) {
				...
				if (introComplete) {
					document.querySelector(".page_portfolio").style.opacity =
						"1";
	...
	const handleLandingTriggerClick = () => {
		setMobile((prev) => !prev);
		setIsOpen(() => {
			const portfolioWork = document.querySelector(
	...
	const moveBetweenPages = (openIdx) => {
		...
		if (prevParentRef.current) {
			...
			prevParentRef.current.parentNode.parentNode.classList.remove(
				"clicked"
			);
		...
		const calculateMouseSpeed = () => {
			...
			if (lastMouseTime && lastMouseTime !== now) {
				const pps = Math.round(
					(mouseTravel / (now - lastMouseTime)) * 1000
				);
				mpoints.push(pps);
			...
			triggers.forEach((trigger) => {
				...
				trigger.addEventListener("mouseover", () => {
					if (cursorRef.current) {
						...
						const cursorIcon =
							cursorRef.current.querySelector(".cursorIcon");
						if (cursorIcon) {
                ...
                <div className="portfolio-animation-container">
                  ...
                  >
                    ...
                    /> */}
									...
									<Navbar
										moveBetweenPages={moveBetweenPages}
										mobile={mobile}
									/>
									{/* </div> */}
									<div
                      ...
                      /> */}
									...
									<div className="slideClone">
										...
										<div className="image parent_4">
											...
											<div className="overlay"></div>
											<div className="cats">
												TEAM OPTICA: THE MINDS BEHIND
												JSCOP
											</div>
											<div className="title">
												Meet the crew making JSCOP 7.0
												magic
											</div>
										</div>
									</div>
									...
									>
										...
										<div className="image parent_5">
											...
											<div className="overlay"></div>
											<div className="cats">
												RELIVE THE MOMENTS, EXPLORE OUR
												GALLERY
											</div>
											<div className="title">
												Browse through memories of our
												events
											</div>
											...
											<div className="image parent_1">
												...
												<div className="content-fix">
													<div className="cats cats_1">
														ALL THE ACTION, ALL IN
														ONE PLACE
													</div>
													<div className="title title_1">
														From Fun Games to Tech &
														ECE Events
													</div>
													<div
										...
										<div className="slider_inner__slide">
											...
											<div className="image parent_4">
												...
												<div className="cats cats_4">
													TEAM OPTICA: THE MINDS
													BEHIND JSCOP
												</div>
												<div className="title title_4">
													Meet the crew making JSCOP
													7.0 magic
												</div>
												<div
										...
										<div className="slider_inner__slide">
											...
											<div className="image parent_5">
												...
												<div className="cats cats_5">
													RELIVE THE MOMENTS, EXPLORE
													OUR GALLERY
												</div>
												<div className="title title_5">
													Browse through memories of
													our events
												</div>
												<div
