...
const Portfolio = () => {
  ...
  useEffect(() => {
    ...
    if (sliderInnerRef.current) {
      ...
      const slideWidth = sliderInnerRef.current.querySelector('.slider_inner__slide').offsetWidth;
    ...
    const handleWheel = (e) => {
      if (e.deltaY > 0) {
        ...
        if (introComplete) {
          ...
          document.querySelector('.page_portfolio').style.clipPath = 'polygon(0 100%, 100% 100%, 100% 0%, 0 0%)';
          document.querySelectorAll('.logo img, .portfolio_home__title h1, .portfolio_home__title hr, .portfolio_home__title img.trigger').forEach(el => {
  ...
  const handleSliderMouseMove = (e) => {
    if (dragging) {
      ...
      const selector = `.slider_inner__slide:nth-of-type(${parseInt(currentIndex + 1)}) .image .overlay, .slider_inner__slide:nth-of-type(${parseInt(currentIndex + 1)}) .image .title, .slider_inner__slide:nth-of-type(${parseInt(currentIndex + 1)}) .image .cats, .slider_inner__slide:nth-of-type(${parseInt(currentIndex + 1)}) .image .button`;
      ...
      if (sliderInnerRef.current) {
        sliderInnerRef.current.style.transform = `translateX(${newDifference + endPosition}px) translateY(120px)`;
      }
    }
  };
  ...
  const handleSliderMouseUp = () => {
    ...
    document.querySelectorAll(`.slider_inner__slide:nth-of-type(${parseInt(newIndex + 1)}) .image .overlay, .slider_inner__slide:nth-of-type(${parseInt(newIndex + 1)}) .image .title, .slider_inner__slide:nth-of-type(${parseInt(newIndex + 1)}) .image .cats, .slider_inner__slide:nth-of-type(${parseInt(newIndex + 1)}) .image .button`).forEach(el => {
      el.style.opacity = 1;
    });
    ...
    const currentClone = document.querySelector(`.slideClone:nth-of-type(${parseInt(newIndex + 2)})`);
    if (currentClone) {
    ...
    const calculateMouseSpeed = () => {
      ...
      if (lastMouseTime && lastMouseTime !== now) {
        ...
        if (dragging) {
          ...
          document.querySelectorAll('.slider_inner__slide').forEach(slide => {
            slide.style.transform = `rotateY(${direction}${pps / 110}deg) scale(1)`;
      ...
      <div className='portfolio'>
        <div className='portfolio_home'>
          ...
          <div className='portfolio_home__title'>
            <div className='logo'>
              <img className='first' src='https://s3-us-west-2.amazonaws.com/s.cdpn.io/217233/clogotemp.png' alt="Logo" />
              <img className='second' src='https://s3-us-west-2.amazonaws.com/s.cdpn.io/217233/clogotemp2.png' alt="Logo" />
                ...
                <div className='portfolio_home__work'>
                  <div className='portfolio_home__header work'>
                    <div className='back' onClick={handleBackClick}>
                      <img className='trigger' src='https://s3-us-west-2.amazonaws.com/s.cdpn.io/217233/arrowDown.png' alt="Arrow" />
                    </div>
                    <div className='logoMain'>
                  ...
                  <div className='slideClone'>
                    ...
                    <div className='image'>
                      <img draggable='false' src='https://s3-us-west-2.amazonaws.com/s.cdpn.io/217233/fud.png' alt="My Protein" />
                  ...
                  <div className='slideClone'>
                    ...
                    <div className='image'>
                      <img draggable='false' src='https://s3-us-west-2.amazonaws.com/s.cdpn.io/217233/nike.png' alt="Nike Air Max" />
                      <div className='overlay'></div>
                  ...
                  <div className='slideClone'>
                    ...
                    <div className='image'>
                      <img draggable='false' src='https://s3-us-west-2.amazonaws.com/s.cdpn.io/217233/rpo.jpg' alt="Apple Watch" />
                      <div className='overlay'></div>
                  ...
                  <div className='slideClone'>
                    ...
                    <div className='image'>
                      <img draggable='false' src='https://s3-us-west-2.amazonaws.com/s.cdpn.io/217233/orangetyhing.png' alt="Jade Teriyaki" />
                      <div className='overlay'></div>
                      <div className='cats'>ADVERTISING   DESIGN   DIGITAL   STRATEGY</div>
                      <div className='title'>Another agency did this campaign, not us</div>
                    </div>
                  </div>
                  <img className='scroll' src='https://s3-us-west-2.amazonaws.com/s.cdpn.io/217233/arrowDown.png' alt="Scroll" />
                </div>
            ...
            <img className='trigger' src='https://s3-us-west-2.amazonaws.com/s.cdpn.io/217233/arrowDown.png' alt="Arrow" onClick={handleTriggerClick} />
          </div>
        </div>
      </div>
    </>
