      ...
      >
        ...
        <div className="card_events__content" ref={contentRef}>
          ...
          <div className="card_events__caption">
            ...
            <p className="card_events__subtitle">{subtitle}</p>{" "}
            {/* Re-added subtitle */}
          </div>
	...
	return (
		...
		<div className="card_events " ref={cardRef}>
			...
			>
				...
				<div
					className="card_events__content event-box"
					ref={contentRef}
				>
					<button
					...
					>
						<img
							className="card_events__btn-close-icon"
							src={cross_icon}
						></img>
					</button>
					{/* Explicit Back button removed */}
					...
					<div className="card_events__copy">
						...
						<div className="meta_events">
							<span className="meta_events__date">
								Date : {date}
							</span>
						</div>
						...
						<div className="event_details__container">
							<div className="event_details">
								...
								{/* {time && (
									<div className="event_details__item">
										<Timer className="event_details__icon" />
										<span className="event_details__text">
											{time}
										</span>
									</div>
								)} */}
								...
								{/* {contact_number && (
									<div className="event_details__item">
										<Phone className="event_details__icon" />
										<span className="event_details__text">
											{contact_number.map(
												(contact, index) => (
													<div key={index}>
							...
							<div
								className="card_events__buttons"
								...
								<div className="faq_section">
									...
									{faq.map((item, index) => (
										<div key={index} className="faq_item">
											...
											>
												{item.question}
												{/* + and - icons are handled via CSS :after pseudo-element */}
											</h4>
											<p className="faq_item__answer">
												{item.answer}
											</p>
										</div>
									))}
...
>>>>>>> 10108b6030032db768753c7767e28126ccbb50f1
}
