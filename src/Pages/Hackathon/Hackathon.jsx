			...
			<div className="container">
				<div className="discord-card">
					<div className="discord-content">
						<h2 className="section-title discord-title">
						...
						<div className="Contact">
							<h3 className="section-title contact-header">
								Contact Us
							</h3>
				...
				<div className="about-content">
					<div className="about-text">
						<p style={{ textAlign: "justify" }}>
							Welcome to TesserX, where the lines between reality
							and imagination blur. Organized by the JIIT Optica
							Student Chapter as a part of JSCOP 7.0, this isn’t
							just a hackathon—it’s a dimensional leap into the
							realm of the extraordinary. Inspired by the concept
							of the Tesseract—a mysterious 4D cube beyond human
							perception—with the theme Interstellar, TesserX
							dares you to challenge the ordinary, bend the rules
							of tech, and craft innovations that exist beyond the
							visible spectrum of reality.
						</p>
						<p></p>
								...
								<ul className="reasons-list">
									<li>
										...
										<span className="reason-desc">
											A reality-warping hackathon designed
											to unlock your most mind-bending
											ideas.
										</span>
									</li>
									<li>
										...
										<span className="reason-desc">
											Top 3 teams plus best projects of
											each domain will win prizes which
									...
									<li>
										...
										<span className="reason-desc">
											All themes, all tech – software or
											hardware(with demo video) – your
