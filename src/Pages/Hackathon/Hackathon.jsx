...
import hacklogo from "/images/hacklogo.jpg";
      ...
      <div className="container">
        <div className="discord-card">
          ...
          <div className="discord-logo">
            <img src={hackathon} alt="TESSERX Logo" className="tesserx-logo" />
          </div>
        </div>
      </div>
    </section>
...
const Stats = () => {
  ...
  return (
    <section className="section stats" id="stats" ref={sectionRef}>
      <h2 className="section-title sponsors-title">Our Gold Sponsor</h2>
      <div className="sponsor-images">
        <div className="sponsor-logos">
          <img src={ethereum} alt="Ethereum Logo" className="sponsor-logo" />
          <h3>ETHIndia</h3>
        </div>
        <div className="sponsor-logos">
          <img src={devfolio1} alt="Ethereum Logo" className="sponsor-logo" />
          <h3>Devfolio</h3>
        </div>
      </div>
...
const Tracks = () => {
  const tracks = [
    ...
    },
    {
      ...
      icon: innovation,
      description:
        "Build any unique and innovative web app beyond the defined tracks.",
      problems: ["Invent a fresh, original web solution."],
    },
  ];
