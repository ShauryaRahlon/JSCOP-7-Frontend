...
const Hackathon = () => {
  ...
  return (
    <>
      <div className="hackathon-main-container">
        <div id="stars"></div>
        <div id="stars2"></div>
        <div id="stars3"></div>
        <div id="title"></div>
        ...
        <div className="hackathon-container-wrapper">
          ...
          >
            <button className="hackathon-button__container">REGISTER</button>
          </a>
        </div>
        ...
        <div className="hackathon-about-wrapper">
          <div className="hackathon-about">
            ...
            <p>
              Launch Ideas Into New Dimensions. Welcome to TessereX — the annual
              flagship hackathon organized by the JIIT Optica Student Chapter,
              proudly hosted at Jaypee Institute of Information Technology,
              Noida – Sector 62. Inspired by the concept of the tesseract — a
              4-dimensional cube that exists beyond the limits of ordinary
              perception — TessereX isn't just a hackathon. It's a journey into
              uncharted territories of innovation, where logic bends, creativity
              thrives, and boundaries dissolve. At TessereX, we challenge
              participants to go beyond conventional thinking. To build what
              hasn’t been built before. To reshape reality with the power of
              code. Whether you're crafting solutions for real-world problems,
              exploring futuristic tech, or simply pushing the limits of your
              imagination — TessereX provides the perfect platform to code,
              create, and conquer. Join us for three days of innovation,
              collaboration, and cosmic creativity. Step into a new dimension of
              hacking.
            </p>
          </div>
        </div>
        ...
        <div className="hackathon-rules">
          ...
          <ul>
            ...
            <li>
              Teams should be made up exclusively of accepted hackers who are
              not organizers, volunteers, mentors, judges, sponsors, or any
              other privileged position at the event.
            </li>
            <li>
              Teams can gain advice and support from organizers, volunteers,
              sponsors, and others.
            </li>
            ...
            <li>
              Teams can work on an idea that they have worked on before (as long
              as they do not re-use code).
            </li>
            <li>
            ...
            <li>
              Adding new features to existing projects is allowed. Judges will
              only consider new functionality introduced or new features added
              during the hackathon.
            </li>
            <li>
              Teams must stop hacking once the time is up. Small bug fixes after
              time is up are allowed.
            </li>
          ...
          <div className="hackathon-faq-items">
            {faqs.map((faq, index) => (
              <div key={index} className="hackathon-faq-item">
                <div
                  className={`hackathon-faq-question ${
                    openIndex === index ? "open" : ""
                  }`}
                  onClick={() => toggle(index)}
                >
                  <span>{faq.question}</span>
                  <span className="hackathon-arrow">
                    {openIndex === index ? "▲" : "▼"}
                  </span>
                </div>
                {openIndex === index && (
